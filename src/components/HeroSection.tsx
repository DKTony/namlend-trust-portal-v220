    ...
    <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 mb-8">
              <div className={cn(
                ...
                <Shield className={cn('w-4 h-4', theme === 'neo' ? (isDark ? 'text-white' : 'text-black') : 'text-green-500')} />
                <span className={cn('text-sm font-bold uppercase tracking-wider', theme === 'neo' ? (isDark ? 'text-white' : 'text-black') : '')}>NAMFISA Licensed</span>
              </div>
              <div className={cn(
                'inline-flex items-center gap-2 px-4 py-2',
                theme === 'neo' 
                ...
                <Zap className={cn('w-4 h-4', theme === 'neo' ? 'text-amber-500' : 'text-amber-500')} />
                <span className={cn('text-sm font-bold uppercase tracking-wider', theme === 'neo' ? (isDark ? 'text-white' : 'text-black') : '')}>5-Min Approval</span>
              </div>
            </div>
            ...
            <h1 className={cn(
              ...
              styles.textClass,
              theme === 'lux' ? 'font-serif leading-tight' : theme === 'neo' ? 'font-mono tracking-tighter leading-[1.0]' : 'font-sans leading-tight'
            )}>
              {theme === 'neo' ? (
                <>
                  Quick Loans for<br />
                ...
                <>
                  Quick Loans for{' '}
                  <span className={cn(
                    theme === 'lux' ? 'text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600' : 
                    'text-blue-500'
                  )}>
                    Every Namibian
                  </span>
            ...
            <div className="grid grid-cols-3 gap-6 max-w-lg mx-auto lg:mx-0">
              ...
              <div className="text-center lg:text-left">
                <div className={cn('text-2xl md:text-3xl font-bold', styles.textClass)}>N$100M+</div>
          ...
          {/* Quick Check Card */}
          <div className="lg:max-w-md mx-auto w-full animate-fade-in-up relative" style={{ animationDelay: '0.2s' }}>
            ...
            <LandingCard className="p-6 md:p-8 relative z-10">
              ...
              <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); handleApplyClick(); }}>
                <div>
