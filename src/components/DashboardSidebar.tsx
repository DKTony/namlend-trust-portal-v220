          ...
          <div className="p-8 pb-4 relative z-10">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="flex flex-col">
                <h2 className={cn("text-xl font-bold tracking-tight leading-none", styles.textClass)}>{title}</h2>
                <p className={cn("text-xs font-medium opacity-60 mt-1 uppercase tracking-wider", styles.textClass)}>{subtitle}</p>
              </div>
            </div>
            ...
            {menuItems.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <ChevronRight size={16} className="relative z-10 animate-in fade-in slide-in-from-left-1" />
                  )}
