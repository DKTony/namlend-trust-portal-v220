...
test.describe('Backoffice Disbursement UI Flow', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    if (role !== 'admin')
      test.skip(true, 'Admin credentials not available; skipping disbursement UI tests');
  ...
  test('Loan status updates after disbursement', async ({ page }) => {
    ...
    await openLoanTab(page, 'All Loans');
...
test.describe('Disbursement Error Handling', () => {
  ...
  test.beforeEach(async ({ page }) => {
    const role = await login(page, true);
    if (role !== 'admin')
      test.skip(true, 'Admin credentials not available; skipping disbursement error tests');
