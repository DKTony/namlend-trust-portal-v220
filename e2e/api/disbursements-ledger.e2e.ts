...
// QUARANTINE: Legacy Supabase direct table access — reads from Supabase `disbursements` table.
// Convex equivalent: api.disbursements.listDisbursements (not yet wired in this test).
