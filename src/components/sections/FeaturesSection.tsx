...
const FeaturesSection = () => (
  <section id="how-it-works" className="relative py-20 md:py-28">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <LandingCard className="mt-16 p-6 md:p-8">
        <div className="flex flex-col items-start gap-6 md:flex-row md:items-center">
          ...
          <div className="flex-1">
            ...
            <p className="mb-4 text-[#274F35]/70">
              OG Financial Services CC is registered as a microlender with NAMFISA. Verified KYC and
              responsible credit review apply to every application.
            </p>
