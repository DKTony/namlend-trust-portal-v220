      ...
      const mockTickets: SupportTicket[] = [
        {
          ...
          description:
            'I am unable to log into my account and view my loan status. Getting error message "Invalid credentials" even with correct password.',
          category: 'technical',
          priority: 'high',
          status: 'open',
        ...
        },
        {
          ...
          description:
            'My monthly payment was charged N$2,800 instead of the agreed N$2,500. Please investigate and refund the difference.',
          category: 'billing',
          priority: 'urgent',
          status: 'in-progress',
        ...
        },
        {
          ...
          description:
            'It has been 2 weeks since I submitted my loan application. Could you please provide an update on the approval status?',
          category: 'loan',
          priority: 'medium',
          status: 'resolved',
        ...
        },
        {
          ...
          description:
            'I need to update my phone number and address in my profile. The current information is outdated.',
          category: 'account',
          priority: 'low',
          status: 'closed',
        ...
        },
        {
          ...
          description:
            'I would like to understand the different loan products available and their respective interest rates and terms.',
          category: 'general',
          priority: 'low',
          status: 'open',
        ...
        },
        {
          ...
          description:
            'The mobile app crashes every time I try to make a payment. This is preventing me from making my monthly payment on time.',
          category: 'technical',
          priority: 'urgent',
          status: 'in-progress',
