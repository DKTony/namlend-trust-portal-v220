      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className={cn(
            ...
            Building financial inclusion for all Namibians with transparent, 
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <p className={cn(
                  ...
                  NamLend is fully licensed under the Microlending Act 2018 and regulated by NAMFISA. 
                  We comply with all KYC/AML requirements under the Financial Intelligence Act 2012.
                </p>
                <div className="flex flex-wrap gap-4">
                  {['NAMFISA License: ML-2024-001', 'Bank of Namibia Authorized', 'FIC Compliant'].map((item, i) => (
