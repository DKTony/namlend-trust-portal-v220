...
export const ThemedSidebar: React.FC<ThemedSidebarProps> = ({ 
  ...
  const menuItems = propMenuItems || (variant === 'admin' ? defaultAdminMenuItems : defaultClientMenuItems);
  ...
  const displaySubtitle = subtitle || (variant === 'admin' ? 'Admin Portal' : brandingConfig.general.company_tagline);
    ...
    <>
      ...
      >
        <div className={cn(
          ...
          <button 
            onClick={() => setIsOpen(false)}
            className={cn('absolute top-4 right-4 p-2 rounded-full hover:bg-white/10', styles.textClass)}
          ...
          <div className="flex items-center gap-3 mb-10 mt-2">
            {brandingConfig.assets.logo_url ? (
              ...
              <div className={cn('w-10 h-10 rounded-xl flex items-center justify-center shadow-lg', styles.accentClass)}>
            ...
            {(brandingConfig.assets.show_company_name_with_logo || !brandingConfig.assets.logo_url) && (
              <div>
                ...
                <p className={cn('text-xs opacity-60', styles.textClass)}>
                  {displaySubtitle}
                </p>
              </div>
            )}
