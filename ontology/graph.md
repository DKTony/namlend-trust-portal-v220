...
Generated from active web, Convex, test, workflow, document, and redacted source-manifest inputs at commit `13342c8c177467953ffed8d470e44ddf7a1ca889`.

| Inventory               | Count |
| ----------------------- | ----: |
| Effective Convex tables |    96 |
| Convex indexes          |   205 |
| Convex functions        |   522 |
| Web routes              |    40 |
