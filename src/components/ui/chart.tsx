...
const RechartsPrimitive = {
  ...
  Tooltip: ({ children }: ChartTooltipProps) => <div>{children}</div>,
  Legend: (_props: ChartLegendProps) => null,
};
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  const colorConfig = Object.entries(config).filter(([_, item]) => item.color);
