...
## CONFLICT-HAS_APPLICATION_TABLE_COUNT-3

- Subject: `system:namlend-convex` / `HAS_APPLICATION_TABLE_COUNT`
- Status: resolved
- Winner: `{"value":89,"tier":"E0","source":"current extraction"}`
- Contradicted source: `{"value":79,"tier":"E2","source":"https://app.notion.com/p/37f83bbf405781698ceccec5515e39e8"}`
- Resolution: Current code at a13c0dcad9208cb15b2c1e8c414957b4a5a7616d wins over the older documented count.
...
## CONFLICT-HAS_E2E_PASS_COUNT-7

- Subject: `system:namlend-tests` / `HAS_E2E_PASS_COUNT`
- Status: resolved
...
## CONFLICT-HAS_E2E_SKIP_COUNT-7

- Subject: `system:namlend-tests` / `HAS_E2E_SKIP_COUNT`
- Status: resolved
...
## CONFLICT-HAS_EFFECTIVE_TABLE_COUNT-3

- Subject: `system:namlend-convex` / `HAS_EFFECTIVE_TABLE_COUNT`
- Status: resolved
- Winner: `{"value":96,"tier":"E0","source":"current extraction"}`
...
## CONFLICT-HAS_EFFECTIVE_TABLE_COUNT-6
...
- Status: resolved
- Winner: `{"value":33,"tier":"E0","source":"current extraction"}`
...
- Status: resolved
- Winner: `{"value":67,"tier":"E0","source":"current extraction"}`
...
## CONFLICT-HAS_GATED_ENTRY_POINT_COUNT-7
...
- Status: resolved
- Winner: `{"value":11,"tier":"E0","source":"current extraction"}`
...
## CONFLICT-HAS_UNIT_PASS_COUNT-6

- Subject: `system:namlend-tests` / `HAS_UNIT_PASS_COUNT`
- Status: resolved
