...
const FeaturesSection = () => {
  const features = [
    ...
    {
      icon: <FileCheck className="w-8 h-8 text-orange-500 dark:text-orange-400" />,
  ...
  return (
    <section id="how-it-works" className="py-20 bg-muted/30 dark:bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="p-6 hover:shadow-medium transition-smooth bg-card border-border">
        ...
        <div className="mt-16 p-6 bg-card rounded-lg border-l-4 border-l-primary shadow-soft">
          <div className="flex items-start space-x-4">
